...
import com.med.disease.tracking.app.validation.SubmitSurveyQuestionValidator;

@RequestScope
@Component
public class SubmitSurveyQuestionHandler extends RestControllerHandler {
	...
	protected void validateRequest() {
		new SubmitSurveyQuestionValidator().validate(requestDTO, bindingResult);
		ErrorUtil.processError(bindingResult, Constant.Module.QUESTION_FETCH);
	}

	@Override
	protected Object processRequest() throws Exception {
		surveyService.submitSurveyQuestions(requestDTO);
